...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
...
#else
            return ControlFreak2.CF2Input.mouseScrollDelta.y * 0.01f;
#endif
        }
        ...
        bool IsBoostPressed()
        {
            ...
            return boost;
#else
            return ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift);
#endif
...
#else
            return ControlFreak2.CF2Input.GetKey(KeyCode.Escape);
#endif
        }
        ...
        bool IsCameraRotationAllowed()
        {
            ...
            return canRotate;
#else
            return ControlFreak2.CF2Input.GetMouseButton(1);
#endif
        }
...
#else
            return ControlFreak2.CF2Input.GetMouseButtonDown(1);
#endif
        }
        ...
        bool IsRightMouseButtonUp()
        {
            ...
            return Mouse.current != null ? !Mouse.current.rightButton.isPressed : false;
#else
            return ControlFreak2.CF2Input.GetMouseButtonUp(1);
#endif
        }
