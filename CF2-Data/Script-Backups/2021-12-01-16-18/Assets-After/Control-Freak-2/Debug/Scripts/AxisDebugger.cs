...
public class AxisDebugger : MonoBehaviour 
	...
	void OnGUI()
		...
		for (int i = 0; i < axes.Count; ++i)
			...
			try { unityAxisVal = ControlFreak2.CF2Input.GetAxis(axis.name); unityAxisAvailable = true; } catch (System.Exception ) {}
	...
	private float GetUnityAxis(string name, float defaultVal = 0)
		...
		try { v = ControlFreak2.CF2Input.GetAxis(name); } catch (System.Exception ) {}
